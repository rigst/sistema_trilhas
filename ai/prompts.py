...
SYSTEM_PERGUNTAS = (
    ...
    "faz perguntas abertas/dissertativas. Responda sempre em português." + DEFESA_INJECAO
)
...
SYSTEM_SUMARIO = (
    ...
    '"Mestre em X"). Responda sempre em português.' + DEFESA_INJECAO
)
...
SYSTEM_SUBTOPICO = (
    ...
    "prática acontece numa etapa separada. Foque em ensinar." + DEFESA_INJECAO
)
...
SYSTEM_ROTEIRO_VIDEO = (
    ...
    "saudações a cada slide)." + DEFESA_INJECAO
)
