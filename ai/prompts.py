...
SYSTEM_SUBTOPICO = (
    ...
    'interação. Varie o tipo: flowchart TD/LR, mindmap, timeline, sequenceDiagram, '
    'pie. Rótulos curtos, em português, numa seção própria.\n'
    '- EXEMPLO CONCRETO em toda seção conceitual importante: código comentado para '
    'temas técnicos (cerca com linguagem: ```python, ```sql…); caso real, cena ou '
    'mini-história para temas não técnicos (direito, história, música, saúde…).\n'
    '- Tabela comparativa quando houver 2+ coisas a contrastar.\n'
    '- Caixas de destaque com conteúdo indentado em 4 espaços:\n'
