...
def criar_trilha(
    user,
    titulo="História do Rio Grande do Sul",
    *,
    ativa=True,
...
class DashboardTests(TestCase):
    def setUp(self):
        ...
        Titulo.objects.create(
            trilha=self.ativa, nivel=n1, nome="Iniciante em Cálculo", faixa=Nivel.Faixa.INICIANTE
        )
    ...
    def test_medalha_ignora_trilha_desativada(self):
        ...
        Titulo.objects.create(
            trilha=self.inativa, nivel=n1, nome="Iniciante Arquivado", faixa=Nivel.Faixa.INICIANTE
        )
        resp = self.client.get(reverse("dashboard"))
...
class QuotaGateTests(TestCase):
    ...
    def test_criar_trilha_rejeita_tema_curto(self):
        ...
        resp = self.client.post(
            reverse("trilhas:criar"), {"tema_livre": "aprender python"}, follow=True
        )
    ...
    def test_criar_trilha_ok_com_quota(self, delay):
        resp = self.client.post(reverse("trilhas:criar"), {"tema_livre": self.TEMA_OK})
